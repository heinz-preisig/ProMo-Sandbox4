...
\hyperlink{"v:25"}{ 11 }\hypertarget{"e:11"}{  } &
    \begin{eq}{{\hat{x}^{A,\alpha}}}{_{N}} := {F}{_{N, A}} \stackrel{A}{\,\star\,} \left({k_A_alpha}{_{A}} \, . \, {D}{_{N, A}} \stackrel{N}{\,\star\,} {{\pi^{A,\alpha}}}{_{N}}\right)\end{eq} &
...
\hyperlink{"v:41"}{ 35 }\hypertarget{"e:35"}{  } &
    \begin{eq}{k_A_alpha}{_{A}} := {K_A_alpha}{_{A}}\end{eq} &
